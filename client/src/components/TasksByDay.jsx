  ...
  const renderWeek = () =>
    Array.from({ length: 7 }).map((_, i) => {
      ...
      return (
        <div
          key={i}
          className="font-[lexend] flex-1 bg-gradient-ash p-2 m-1 rounded-lg shadow-md min-h-[250px]"
        >
          <h3 className="text-center text-onyx text-lg font-semibold mb-2">
              ...
              {dayTasks.map((todo) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="ml-2 text-2xl text-amaranth bg-transparent relative right-2"
                  >
                    &times;
                  </button>
                </li>
  ...
  return (
    <div className="font-[lexend] w-full my-8 p-4 font-sans">
      <div className="bg-gradient-ash shadow-md p-4 rounded-lg mb-6 flex items-center justify-between">
        <button onClick={() => shiftWeek(-1)} className="btn-nav font-bold">
          &#60;
        </button>
